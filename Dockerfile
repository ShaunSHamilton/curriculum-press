...
LABEL org.opencontainers.image.title="Curriculum Press" \
      org.opencontainers.image.description="Rust Axum + React application for exam creation and management" \
      org.opencontainers.image.source="https://github.com/freeCodeCamp/curriculum-press" \
      org.opencontainers.image.vendor="curriculum-press" \
